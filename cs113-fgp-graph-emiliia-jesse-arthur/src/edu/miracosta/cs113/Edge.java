...
public class Edge
{
    ...
    /**
     * Return true if two edges are equal. Edges are equal if the source and destination are equal.
    ...
    /**
     * Return a hash code for an edge. The hash code is the source shifted left 16 bits exclusive or with the dest

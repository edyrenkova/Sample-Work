...
[![Build Status](https://travis-ci.com/MiraCostaCS-Nery/cs113-gp2-stackintegercalculator-jesse-emiliia.svg?token=yBdCJcomVoGVsyZzqqxR&branch=master)](https://travis-ci.com/MiraCostaCS-Nery/cs113-gp2-stackintegercalculator-jesse-emiliia)
...
>The Stack implementation we will be using is ArrayListStack because of labor efficiency (we have it implemented from previous homeworks). Java built in VectorStack is not efficient because Vector is good for multithreading only.

## Sprint 1
**User Story**:
>As a user I want to perform integer calculations such as multiplication, division, addition, subtraction.

**Definition Of Done**:
- [x] Implement the conversion from infix to postfix
- [x] Implement the evaluation of postfix
...
## Sprint 2
**User Story**:
>As a user I want to be able to find derivatives of single terms.

**Definition Of Done**:
- [x] Implement derivatives
- [x] General requirements 
	- *Code adheres to coding standard/convention*
	- *Code is documented*
	- *Code checked into GitHub*

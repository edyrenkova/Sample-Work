...
public class DoubleLinkedListTest {
    ...
    public void testEquals() {
        ...
        assertEquals("Expected String list (java.util.LinkedList) and Actual String list (your implementation) don't match", stringList,stringListJava);
        assertEquals("Expected Integer list (java.util.LinkedList) and Actual Integer list (your implementation) don't match",intList, intListJava);
        assertEquals("Expected Character list (java.util.LinkedList) and Actual Character list (your implementation) don't match", charList,charListJava);
        assertEquals("Expected Double list (java.util.LinkedList) and Actual Double list (your implementation) don't match",doubleList, doubleListJava);
    }
